...
TOP_HOT_PHRASES: dict[str, list[str]] = {
    "hi-IN": [
        ...
        # Commit / close
        "Main aapko quote bhejti hoon.",
        "Aaj sham tak email kar deti hoon.",
        "Sample chahiye toh bhej sakte hain.",
        "WhatsApp pe details bhej dun?",
        "Aapke saath baat karke acha laga.",
        # Soft probes
        "Aapke saath kuch aisa hai?",
        "Iska impact kya hota hai?",
        "Aap kya monthly volume sochte hain?",
    ],
    "en-IN": [
        "Got it.",
        "I see.",
        ...
        "I'll email by end of day.",
        "We can send a sample if you'd like.",
    ...
    "ta-IN": [
        ...
        "Naan ungalukku quote anuppuren sir.",
        "Sample venumna anuppuren sir.",
        "WhatsApp la details anuppalaamaa sir?",
        "Ungalode pechu nallaa irundhuchu sir.",
        "Andha problem ungalukku irukkaa sir?",
        "Adhanale enna impact aagudhu sir?",
        "Ovvoru maatham evlo venum sir?",
    ],
}
