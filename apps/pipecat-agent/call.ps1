...
#   .\call.ps1 9876543210                       (default Hindi)
#   .\call.ps1 9876543210 Suresh ta             (Tamil)
#   .\call.ps1 9876543210 Suresh ta-IN          (Tamil, explicit)
#   .\call.ps1 +919876543210 Suresh en          (English)
#
# Args: <number> [name] [lang]
#   lang accepts: hi | ta | en  OR  hi-IN | ta-IN | en-IN  (case-insensitive)
param(
